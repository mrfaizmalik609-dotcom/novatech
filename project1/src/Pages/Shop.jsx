...
const products = [
  ...
  { id: 3, name: "HP Portable", price: 39.99, image: product3, ram: "8 GB", battery: "5000 mAh", description: "Lightweight and portable laptop for everyday use." },
  { id: 4, name: "DELL Gaming", price: 49.99, image: product4, ram: "32 GB", battery: "6000 mAh", description: "High-end gaming laptop with RGB keyboard." },
  ...
  { id: 6, name: "DELL Essential", price: 69.99, image: product6, ram: "8 GB", battery: "4000 mAh", description: "Affordable laptop with great performance." },
  { id: 7, name: "LENOVO Creative", price: 79.99, image: product7, ram: "24 GB", battery: "5200 mAh", description: "Creative laptop optimized for multimedia tasks." },
  ...
  { id: 9, name: "LENOVO Pro", price: 99.99, image: product9, ram: "32 GB", battery: "6000 mAh", description: "Premium laptop for professionals and developers." },
  ...
  { id: 12, name: "APPLE MacBook Pro", price: 129.99, image: product12, ram: "16 GB", battery: "8000 mAh", description: "Sleek MacBook with Retina display and all-day battery life." },
];
